...
const TABS = [
  ...
  { value: "carpark", label: "Carpark",  icon: <LocalParkingIcon  fontSize="small" /> },
  { value: "traffic", label: "Traffic",  icon: <TrafficIcon       fontSize="small" /> },
];
        ...
        <Toolbar variant="dense" sx={{ minHeight: 50, px: 2.5, gap: 0 }}>
          ...
          <Tabs
            ...
            sx={{
              ...
              "& .MuiTab-root": { minHeight: 50, textTransform: "none", fontSize: 13, fontWeight: 400, px: 2 },
